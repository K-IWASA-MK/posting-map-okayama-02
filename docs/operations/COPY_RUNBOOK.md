...
新地区作成は、必ず **【コピー前作業 ➔ コピー実行 ➔ 新地区化 ➔ プロビジョニング ➔ 監査】** の順序で執行します。

### Step 0: コピー前作業＆ゲート通過（必須先行ゲート）
親機フォルダーの複製を実行する前に、必ず [.agents/rules/district-pre-copy-rule.md](../../.agents/rules/district-pre-copy-rule.md) の **コピー前作業10項目チェックリスト** および **コピー前ゲート（開始禁止条件7項目がすべて0件）** を全数確認し、PASSしていなければなりません。
> 🛑 **強制停止**: コピー前ゲートがPASSする前に Step 1（フォルダーコピー）へ進むことは絶対禁止とします。
